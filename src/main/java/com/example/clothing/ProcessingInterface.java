...
public class ProcessingInterface {
    ...
    public UserToken createAccount(UserToken USERTOKEN) {
        ...
        String sql = "INSERT INTO user_data (id, username, hashedpassword, dob, sex) VALUES (:id, :username, :hashedpassword, null, null)"; 
        int rowsAffected = USER_DATA_ACCESS_SERVICE.insertNewUser(sql, USERTOKEN.ID, USERTOKEN.USERNAME, USERTOKEN.HASHEDPASSWORD);
    ...
    public int generateNewID() {
        String sql = "SELECT MAX(id) AS largestId FROM user_data";
    ...
    public List<ProductToken> getUserProduct(int ID) {
